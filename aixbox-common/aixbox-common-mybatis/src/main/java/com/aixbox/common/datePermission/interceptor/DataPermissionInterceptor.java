package com.aixbox.common.datePermission.interceptor;


import com.aixbox.common.datePermission.handler.DataPermissionHandler;
...
public class DataPermissionInterceptor extends BaseMultiTableInnerInterceptor implements InnerInterceptor {
    ...
    public DataPermissionInterceptor(String mapperPackage) {
        this.dataPermissionHandler = new DataPermissionHandler(mapperPackage);
    }
    ...
    public void beforeQuery(Executor executor, MappedStatement ms, Object parameter, RowBounds rowBounds, ResultHandler resultHandler, BoundSql boundSql) throws SQLException {
        ...
        // 检查是否缺少有效的数据权限注解, 这里的ms.getId() 是mybatis接口类.方法名 clazz.getName() + "." + method.getName()
