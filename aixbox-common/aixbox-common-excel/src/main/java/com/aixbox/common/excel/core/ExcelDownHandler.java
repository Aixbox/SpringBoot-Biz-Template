package com.aixbox.common.excel.core;
...
import com.aixbox.common.excel.annotation.ExcelEnumFormat;
        ...
        for (Map.Entry<Integer, FieldWrapper> entry : fieldCache.getSortedFieldMap().entrySet()) {
            ...
            if (field.isAnnotationPresent(ExcelDictFormat.class)) {
                ...
                if (StrUtils.isNotBlank(dictType)) {
                    ...
                    // 如果指定了确切的值，则直接解析确切的值
                    List<String> strList = StrUtils.splitList(converterExp, format.separator());
                    options = StreamUtils.toList(strList, s -> StrUtils.split(s, "=")[1]);
                }
