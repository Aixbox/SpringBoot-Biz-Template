package com.aixbox.common.redis.utils;
...
public class SequenceUtils {
    ...
    public static String nextIdDate(String prefix) {
        // 前缀+日期 构建 prefixKey
        String prefixKey = StrUtils.format("{}{}", StrUtils.blankToDefault(prefix, ""), DateUtil.format(DateUtil.date(), DatePattern.PURE_DATE_FORMATTER));
        // 获取下一个id
    ...
    public static String nextIdDateTime(String prefix) {
        ...
        String prefixKey = StrUtils.format("{}{}", StrUtils.blankToDefault(prefix, ""), DateUtil.format(DateUtil.date(), DatePattern.PURE_DATETIME_FORMATTER));
        // 获取下一个id
