...
import com.aixbox.generator.config.GenConfig;
...
public class GenUtils {
    ...
    public static String getBusinessName(String tableName) {
        ...
        businessName = StrUtils.toCamelCase(businessName);
        return businessName;
    }
    ...
    public static String convertClassName(String tableName) {
        ...
        if (autoRemovePre && StrUtils.isNotEmpty(tablePrefix)) {
            String[] searchList = StrUtils.split(tablePrefix, StrUtils.SEPARATOR);
