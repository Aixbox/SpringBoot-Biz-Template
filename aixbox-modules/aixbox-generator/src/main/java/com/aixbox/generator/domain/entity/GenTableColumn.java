package com.aixbox.generator.domain.entity;
...
public class GenTableColumn extends BaseDO {
    ...
    public String getCapJavaField() {
        return StrUtils.capitalize(javaField);
    }
        ...
        if (StrUtils.isNotEmpty(remarks)) {
            for (String value : remarks.split(" ")) {
                if (StrUtils.isNotEmpty(value)) {
                    ...
                    sb.append(StrUtils.EMPTY).append(startStr).append("=").append(endStr).append(StrUtils.SEPARATOR);
                }
            }
